    ...
    return (
      <>
        ...
        <footer className="w-full text-emerald-200">
          {/*    <!-- Main footer --> */}
          <div className="pt-16 pb-12 text-sm border-t border-emerald-600 bg-green-700  mt-4">
          ...
          {/*    <!-- Subfooter --> */}
          <div className="py-4 text-sm border-t bg-lime-700">
            <div className="container px-6 mx-auto">
              <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
                <div className="col-span-2 md:col-span-4 lg:col-span-6 hover:text-white text-black underline">
                  ...
                  <ul className="flex items-center justify-end gap-4">
                    <li>
                      <a
                        ...
                        className="transition-colors duration-300 hover:text-white text-black"
                      >
                        <svg
